...
export default function AboutUsOurCompany() {
  ...
  const sliderSettings = {
      dots: false,
      infinite: true,
      speed: 5000, // Slower for smoother readability
      slidesToShow: 1,
      slidesToScroll: 1,
      autoplay: true,
      autoplaySpeed: 0,
  ...
  return (
    <div className="bg-white min-h-screen w-full overflow-x-hidden overscroll-none font-['Rethink_Sans',sans-serif] text-slate-900 selection:bg-[#00A2FF] selection:text-white [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
      <style>{`
        html, body {
      ...
      <main>
        ...
        <section id="schedule" className="py-20 md:py-32 bg-slate-50/50">
           <div className="container mx-auto px-4 md:px-8">
              ...
              >
                 ...
                 <Button className="w-full md:w-auto rounded-full bg-slate-900 text-white hover:bg-slate-800 h-12 shadow-lg hover:shadow-xl transition-all">
        ...
        <section id="apply" className="py-20 md:py-32 container mx-auto px-4 md:px-8">
           <div className="bg-slate-900 rounded-[40px] text-white p-8 md:p-16 flex flex-col lg:flex-row gap-16 relative overflow-hidden shadow-2xl">
              ...
              <motion.div 
                className="lg:w-1/2 bg-white text-slate-900 rounded-3xl p-8 shadow-xl relative z-10"
                initial={{ opacity: 0, y: 30 }}
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true }}
                transition={{ delay: 0.3 }}
              >
                 ...
                 <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
                    <div className="grid grid-cols-2 gap-4">
                       <input type="text" placeholder={c.apply.form.name} className="w-full p-4 bg-slate-50 rounded-xl border border-slate-200 focus:outline-none focus:border-[#00A2FF] focus:ring-2 focus:ring-blue-100 transition-all" />
                       <input type="text" placeholder={c.apply.form.age} className="w-full p-4 bg-slate-50 rounded-xl border border-slate-200 focus:outline-none focus:border-[#00A2FF] focus:ring-2 focus:ring-blue-100 transition-all" />
                    </div>
                    <input type="text" placeholder={c.apply.form.phone} className="w-full p-4 bg-slate-50 rounded-xl border border-slate-200 focus:outline-none focus:border-[#00A2FF] focus:ring-2 focus:ring-blue-100 transition-all" />
                    <input type="text" placeholder={c.apply.form.city} className="w-full p-4 bg-slate-50 rounded-xl border border-slate-200 focus:outline-none focus:border-[#00A2FF] focus:ring-2 focus:ring-blue-100 transition-all" />
                    
                    <select className="w-full p-4 bg-slate-50 rounded-xl border border-slate-200 focus:outline-none focus:border-[#00A2FF] focus:ring-2 focus:ring-blue-100 transition-all">
                       <option value="">{c.apply.form.prog}</option>
                       <option value="magang">Internship (Magang)</option>
                       <option value="tg">Tokutei Ginou (TG)</option>
                       <option value="ssw">SSW Exam Track</option>
                    </select>

                    <Button className="w-full h-14 bg-[#00A2FF] hover:bg-[#008ce6] text-white rounded-xl font-bold text-lg mt-4 shadow-lg shadow-blue-200 hover:shadow-xl transition-all hover:-translate-y-1">
                       {c.apply.form.submit}
                    </Button>
      ...
      <motion.a
        href="https://wa.me/6285117832026"
        target="_blank"
